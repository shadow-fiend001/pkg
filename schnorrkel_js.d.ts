...
* @returns {Uint8Array} 
*/
export function to_public(secret: Uint8Array): Uint8Array;
/**
* Sign a message
*
...
* @returns {Uint8Array} 
*/
export function sign(public_key: Uint8Array, secret: Uint8Array, message: Uint8Array): Uint8Array;
/**
...
* @returns {boolean} 
*/
export function verify(signature: Uint8Array, message: Uint8Array, public_key: Uint8Array): boolean;
